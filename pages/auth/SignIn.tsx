...
export const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userType = displayName.toLowerCase().includes('seller') ? 'seller' : 'buyer';

      setUser({
        uid: user.uid,
        name: displayName,
        email: user.email || '',
        type: userType as 'buyer' | 'seller',
      });

      navigate(userType === 'buyer' ? '/buyer/categories' : '/seller/dashboard');
    } catch (err: any) {
